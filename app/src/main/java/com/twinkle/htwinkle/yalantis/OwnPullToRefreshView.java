package com.twinkle.htwinkle.yalantis;
...
public class OwnPullToRefreshView extends ViewGroup {
    ...
    private OwnBaseRefreshView mBaseRefreshView;
    ...
    public OwnPullToRefreshView(Context context) {
        this(context, null);
    }

    public OwnPullToRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
        @SuppressLint("CustomViewStyleable") TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RefreshView);
    ...
    public void setRefreshStyle(int type) {
        ...
        switch (type) {
            case STYLE_SUN:
                mBaseRefreshView = new OwnSunRefreshView(getContext(), OwnPullToRefreshView.this);
                break;
            default:
