...
public abstract class OwnBaseRefreshView extends Drawable implements Drawable.Callback, Animatable {

    private OwnPullToRefreshView mRefreshLayout;
    private boolean mEndOfRefreshing;

    public OwnBaseRefreshView(Context context, OwnPullToRefreshView layout) {
    ...
    public OwnPullToRefreshView getRefreshLayout() {
